      ...
      <div className="container mx-auto px-4 py-20 relative z-10">
        <div className="grid md:grid-cols-2 gap-12 items-center">
          ...
          <div className="space-y-8 text-center md:text-left animate-fade-in">
            ...
            <div className="flex items-center justify-center md:justify-start gap-6 text-sm text-muted-foreground pt-4">
              ...
              <div className="flex items-center gap-2">
                <svg className="w-5 h-5 text-botanical" fill="none" stroke="currentColor" viewBox="0 0 24 24">
